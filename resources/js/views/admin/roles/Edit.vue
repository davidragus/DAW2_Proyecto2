            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form @submit.prevent="submitForm">
                        ...
                        <PickList v-model="permisions" dataKey="id" breakpoint="1400px" striped
                                  :pt="{
                                   root: { class: 'picklist' },
...
const {role: postData,updateRolePermissions,
    getRole,
    updateRole,
    validationErrors,
    isLoading
...
const permisions = ref(  [diffPermission, rolePermissionList]);
