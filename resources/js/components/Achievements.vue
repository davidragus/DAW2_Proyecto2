<template>
    <div id="mainContent" class="d-flex">
        <aside class="sidebar">
            <ul>
                <li><RouterLink to="/my-account" class="router-link-active">ACCOUNT DETAILS</RouterLink></li>
        ...
        <div v-if="selectedAchievement" class="modal-overlay" @click.self="closeAchievementDialog">
            <div class="modal-content">
                ...
                <p v-if="selectedAchievement.obtained_date" class="text-white">Obtained on: {{ selectedAchievement.obtained_date }}</p>
