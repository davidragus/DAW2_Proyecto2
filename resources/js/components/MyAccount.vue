            ...
            <div class="row justify-content-center ">
                ...
                <div class="col-12 col-md-6">
                    <form @submit.prevent="submitForm" class="mb-3">
                        ...
                        <button type="button" class="btn background-yellow w-100" v-if="!changePasswordVisible" @click="changePasswordVisible = !changePasswordVisible" >CHANGE PASSWORD</button>
                    </form>
                    <form @submit.prevent="submitChangePasswordForm" v-if="changePasswordVisible">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="currentPassword"
                                v-model="changePassword.current_password" :class="{ 'is-invalid': changePasswordErrors.current_password }">
                            <div v-if="changePasswordErrors.current_password" class="invalid-feedback">{{ changePasswordErrors.current_password }}</div>
                        </div>
                        <div class="mb-3">
                            <label for="newPassword" class="form-label">New password</label>
                            <input type="password" class="form-control" id="newPassword"
                                v-model="changePassword.new_password" :class="{ 'is-invalid': changePasswordErrors.new_password }">
                                <div v-if="changePasswordErrors.new_password" class="invalid-feedback">{{ changePasswordErrors.new_password }}</div>
                        </div>
                        <div class="mb-3">
                            <label for="confirmPassword" class="form-label">Confirm password</label>
                            <input type="password" class="form-control" id="confirmPassword"
                                v-model="changePassword.confirm_password" :class="{ 'is-invalid': changePasswordErrors.confirm_password }">
                            <div v-if="changePasswordErrors.confirm_password" class="invalid-feedback">{{ changePasswordErrors.confirm_password }}</div>
                        </div>
                        <button type="submit" class="btn background-red w-100 mb-3">CHANGE PASSWORD</button>
                        <button type="button" class="btn border-yellow w-100" @click="changePasswordVisible = !changePasswordVisible; changePasswordErrors = {}">CANCEL</button>
                    </form>
                </div>
            </div>
        </div>
