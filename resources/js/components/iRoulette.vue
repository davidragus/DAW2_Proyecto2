<template>
  <svg xmlns="http://www.w3.org/2000/svg" id="Capa_2" version="1.1" viewBox="0 0 32 32" :class="{'dark-icon': mode === 'dark'}">
...
const isDarkMode = ref(props.mode === 'dark');
