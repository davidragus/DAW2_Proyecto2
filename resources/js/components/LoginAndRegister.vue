<template>
	<div class="d-flex gap-3">
		<Login @open-register-dialog="openRegisterDialog" :visible="loginDialogVisible"
			@update:visible="updateLoginDialogVisible" />
		<Register @open-login-dialog="openLoginDialog" :visible="registerDialogVisible"
			@update:visible="updateRegisterDialogVisible" />
	</div>
</template>
