<template>
	<footer id="mainFooter" class="d-flex flex-column">
		<div class="d-flex flex-row w-100 justify-content-between p-5 footer-content">
			<ul>
				<li :class="{ 'clickable': isMobile }" class="li-title" @click="toggleList(0)"><strong>Casino
						games</strong></li>
			...
			<ul>
				<li :class="{ 'clickable': isMobile }" class="li-title" @click="toggleList(1)"><strong>Who we
						are</strong></li>
			...
			<ul>
				<li :class="{ 'clickable': isMobile }" class="li-title" @click="toggleList(2)"><strong>Safe
						play</strong></li>
			...
			<ul>
				<li :class="{ 'clickable': isMobile }" class="li-title" @click="toggleList(3)"><strong>Real
						money</strong></li>
				<li v-show="isListVisible[3] || !isMobile"><a href="">Payments</a></li>
				<li v-show="isListVisible[3] || !isMobile"><a href="">Charges</a></li>
				<li v-show="isListVisible[3] || !isMobile"><a href="" @click.prevent="routeVerifyIndentity">Verify
						identity</a></li>
			</ul>
			<ul>
		...
		<div class="ps-5 pb-3">
			<p class="text-white">Copyright © 2025. Royal Flush Casino S.A.</p>
		</div>
	</footer>
</template>
